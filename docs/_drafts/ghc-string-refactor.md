...
1. Multiline strings need to defer escaping characters until after reading all the characters in, conflicting with the logic to resolve escape characters at the same time as reading the characters
